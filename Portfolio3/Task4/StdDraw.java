...
/////////////////////////////////////////////////////////////////////////////////
// Task 4 Portfolio 3
// Included Area and Shape class for manipulation and creation of complex shapes
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * drawUnion
     * 
     * Draws a unionised shape of a circle and rectangle - combined into one shape
     * @param x1 - The Circle's X 
     * @param y1 - The Circle's Y
     * @param x2 - The Rectangle's X
     * @param y2 - The Rectangle's Y
     * @param w1 - The width of the circle
     * @param h1 - The height of the circle
     * @param w2 - The width of the rectangle
     * @param h2 - The height of the rectangle
     */
    public static void drawUnion(double x1, double y1, double x2, double y2, double w1, double h1, double w2, double h2){
        Ellipse2D   circle = new Ellipse2D.Double(); // Creates a circle shape
        Rectangle2D rect = new Rectangle2D.Double(); // Creates a rectangle shape
        
        // Applies the sizing and position of the circle and rectangle
        circle.setFrame(x1, y1, w1, h1);
        rect.setFrame(x2, y2, w2, h2); 
        
        // Create areas for each shape
        Area c = new Area(circle);
        Area r = new Area(rect);
      
        // Call Union function
        c.add(r); // Preform the union
      
        offscreen.fill(c); // Fill the unionised shape with a color
        offscreen.draw(c); // Draw the unionised shape
        
        draw(); // Draw the offscreen buffer 
    }
     ...
     * drawDifference
     * 
     * Draws a shape of a circle using the rectangle to delete pixels from the circle - Difference in areas between the circle and the rectangle
     * @param x1 - The Circle's X 
     * @param y1 - The Circle's Y
     * @param x2 - The Rectangle's X
     * @param y2 - The Rectangle's Y
     ...
     * @param h2 - The height of the rectangle
     */
    public static void drawDifference(double x1, double y1, double x2, double y2, double w1, double h1, double w2, double h2){
        ...
        c.subtract(r); // Prefrom the difference
        
        offscreen.fill(c); // Fill the complex shape with a color
        offscreen.draw(c); // Draw the difference between shapes
     ...
     * drawIntersection
     * 
     * Draws a shape of a circle using the rectangle to only show pixels inside e.g. 
     * if the circle is inside the square, part of the circle will be shown based on the area 
     * that is intersecting between the two shapes
     * 
     * @param x1 - The Circle's X 
     * @param y1 - The Circle's Y
     * @param x2 - The Rectangle's X
     ...
     * @param h2 - The height of the rectangle
     */
    public static void drawIntersection(double x1, double y1, double x2, double y2, double w1, double h1, double w2, double h2){
        Ellipse2D circle = new Ellipse2D.Double(); // Creates a circle
        Rectangle2D rect = new Rectangle2D.Double(); // Creates a Rectangle
        
        // Applies the sizing and position of the circle and rectangle
        circle.setFrame(x1, y1, w1, h1);
        rect.setFrame(x2, y2, w2, h2);
        
        // Create Areas of the shapes
        Area c = new Area(circle);
        Area r = new Area(rect);
        
        c.intersect(r); // Preform the intersection
       
        offscreen.fill(c); // Fill the complex shape with a color
        offscreen.draw(c); // Draw the intersection between shapes
     ...
     * drawExclusiveOr
     * 
     * Draws a combined shape of the circle and the rectangle, only removing pixels if they begin to overlap.
     * 
     * @param x1 - The Circle's X 
     * @param y1 - The Circle's Y
     * @param x2 - The Rectangle's X
     ...
     * @param h2 - The height of the rectangle
     */
    public static void drawExclusiveOr(double x1, double y1, double x2, double y2, double w1, double h1, double w2, double h2){
        Ellipse2D circle = new Ellipse2D.Double(); // Creates a Circle
        Rectangle2D rect = new Rectangle2D.Double(); // Creats a Rectangle
        ...
        // Call the exclusiveOr function
        c.exclusiveOr(r); // Preform the exclusiveOr
       
        offscreen.fill(c); // Fill the complex shape with a color
        offscreen.draw(c); // Draw the ExclusiveOr shape
